    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dateLastModification', models.DateTimeField(blank=True, default=django.utils.timezone.now, verbose_name='Last modification')),
                ...
                ('educationLevel', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='resources.EducationLevel')),
                ('keywords', models.ManyToManyField(to='resources.Keyword')),
                ('learningResourceType', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='resources.LearningResourceType')),
