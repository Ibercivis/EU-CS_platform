...
class ProjectForm(forms.Form):
    ...
    image1 = forms.ImageField(required=False,label="Image 1 (Will be resized to 400x300 pixels)")
    ...
    image2 = forms.ImageField(required=False, label="Image 2: Logo (Will be resized to 400x300 pixels)")
